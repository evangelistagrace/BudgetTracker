                                                                ...
                                                                <div class="card-text">
                                                                    <div class="row" style="width:100%">
                                                                        ...
                                                                        <section class="mini-section">
                                                                            <?php 
                                                    $query = pg_query("SELECT SUM(budgetamount) as totalbudget FROM groupbudgets WHERE groupingid = $groupingid "); 
                            ...
                            <table class='table budget'>
                                <tr>
                                    <td style="width:100%" colspan="2">
                                        <?php 
                                            $query2 = pg_query("SELECT SUM(expenseamount) as amount FROM groupexpenses WHERE budgetid = '".$result['budgetid']."' AND groupingid = $groupingid "); 
                                            $result2 = pg_fetch_array($query2);
                                ...
                                <tr>
                                <td style="text-align:left; padding-bottom:25px"><?php echo $result['budgetname'] ?></td>
