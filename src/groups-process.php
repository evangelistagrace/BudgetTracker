...
// delete group
if(isset($_GET['del-grouping-id'])){
    $groupingid = $_GET['del-grouping-id'];

    $query = pg_query("DELETE FROM groups WHERE groupingid = '$groupingid' ");
...
if(isset($_POST['edit-group'])){
    ...
    $query = pg_query("UPDATE groups SET groupname = '$groupname', groupicon = '$groupicon' WHERE adminusername = '".$_SESSION['username']."' ");
